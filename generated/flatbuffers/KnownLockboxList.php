...
class KnownLockboxList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return KnownLockboxList
     */
    public static function getRootAsKnownLockboxList(ByteBuffer $bb)
    {
        $obj = new KnownLockboxList();
     ...
     * @return void
     */
    public static function startKnownLockboxList(FlatbufferBuilder $builder)
    {
     ...
     * @return KnownLockboxList
     */
    public static function createKnownLockboxList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endKnownLockboxList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
