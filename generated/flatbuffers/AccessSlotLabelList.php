...
class AccessSlotLabelList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AccessSlotLabelList
     */
    public static function getRootAsAccessSlotLabelList(ByteBuffer $bb)
    {
        $obj = new AccessSlotLabelList();
     ...
     * @return void
     */
    public static function startAccessSlotLabelList(FlatbufferBuilder $builder)
    {
     ...
     * @return AccessSlotLabelList
     */
    public static function createAccessSlotLabelList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endAccessSlotLabelList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
