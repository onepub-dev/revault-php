...
class FormFieldList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FormFieldList
     */
    public static function getRootAsFormFieldList(ByteBuffer $bb)
    {
        $obj = new FormFieldList();
     ...
     * @return void
     */
    public static function startFormFieldList(FlatbufferBuilder $builder)
    {
     ...
     * @return FormFieldList
     */
    public static function createFormFieldList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endFormFieldList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
