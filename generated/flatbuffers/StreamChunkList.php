...
class StreamChunkList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return StreamChunkList
     */
    public static function getRootAsStreamChunkList(ByteBuffer $bb)
    {
        $obj = new StreamChunkList();
     ...
     * @return void
     */
    public static function startStreamChunkList(FlatbufferBuilder $builder)
    {
     ...
     * @return StreamChunkList
     */
    public static function createStreamChunkList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endStreamChunkList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
