...
class ProfileHistoryList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ProfileHistoryList
     */
    public static function getRootAsProfileHistoryList(ByteBuffer $bb)
    {
        $obj = new ProfileHistoryList();
     ...
     * @return void
     */
    public static function startProfileHistoryList(FlatbufferBuilder $builder)
    {
     ...
     * @return ProfileHistoryList
     */
    public static function createProfileHistoryList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endProfileHistoryList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
