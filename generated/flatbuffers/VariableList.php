...
class VariableList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return VariableList
     */
    public static function getRootAsVariableList(ByteBuffer $bb)
    {
        $obj = new VariableList();
     ...
     * @return void
     */
    public static function startVariableList(FlatbufferBuilder $builder)
    {
     ...
     * @return VariableList
     */
    public static function createVariableList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endVariableList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
