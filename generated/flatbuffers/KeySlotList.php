...
class KeySlotList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return KeySlotList
     */
    public static function getRootAsKeySlotList(ByteBuffer $bb)
    {
        $obj = new KeySlotList();
     ...
     * @return void
     */
    public static function startKeySlotList(FlatbufferBuilder $builder)
    {
     ...
     * @return KeySlotList
     */
    public static function createKeySlotList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endKeySlotList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
