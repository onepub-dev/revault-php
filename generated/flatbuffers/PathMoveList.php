...
class PathMoveList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PathMoveList
     */
    public static function getRootAsPathMoveList(ByteBuffer $bb)
    {
        $obj = new PathMoveList();
     ...
     * @return void
     */
    public static function startPathMoveList(FlatbufferBuilder $builder)
    {
     ...
     * @return PathMoveList
     */
    public static function createPathMoveList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endPathMoveList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
