...
class AgentEntryList extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AgentEntryList
     */
    public static function getRootAsAgentEntryList(ByteBuffer $bb)
    {
        $obj = new AgentEntryList();
     ...
     * @return void
     */
    public static function startAgentEntryList(FlatbufferBuilder $builder)
    {
     ...
     * @return AgentEntryList
     */
    public static function createAgentEntryList(FlatbufferBuilder $builder, $values)
    {
        $builder->startObject(1);
     ...
     */
    public static function endAgentEntryList(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
